...
{   
  ...
  struct ContextToTest : public ContextProvider<ContextToTest, ContextWithAttribute<void>, void, false, false >
  {
    void SetUp()
    {
      log = "SetUp called ";
    ...
    struct InnerContext : public ContextProvider<InnerContext, ContextToTest, ContextToTest, false, false>
    {
      void SetUp()
      {
